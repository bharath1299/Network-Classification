...
class Burst(object):
    ...
    def split(self, packets, threshold=1):
        ...
        data_processed = len(packets)  # Total number of packets processed
        #After bursts creation
        log_resource_utilization("After Bursts Created", data_processed=data_processed, start_time=start_time)
        # Return result
        return result
