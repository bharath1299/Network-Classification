...
class Flow(object):
    ...
    def extract(self, bursts):
        ...
        # Calculate the number of bursts processed
        bursts_processed = len(bursts)
        
        #After flow creation
        log_resource_utilization("After Flow Creation", data_processed=bursts_processed, start_time=start_time)
