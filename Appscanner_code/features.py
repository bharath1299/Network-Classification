...
class Features(object):
    ...
    def extract(self, flows):
        ...
        # Calculate the number of flows processed
        flows_processed = len(flows)

        #After feature extraction
        log_resource_utilization("After Feature Extraction from Flows", data_processed=flows_processed, start_time=start_time)
        # Return result
        return result
